  ...
  return (
    <>
      ...
      <section className="flex flex-col md:flex-row mx-10 md:mx-0 items-center justify-around mt-20 md:mt-28 mb-40">
        <div className="hidden md:flex flex-row md:flex-col xl:flex-row gap-5 items-center text-center">
          <img src={NewLogo} alt="logo" className="h-[48px] md:h-[200px] w-auto" />
