...
export default function RegisterForm() {
	...
	return (
		<>
			{/* REGISTRATION FORM */}
			<div className="shadow-2xl max-w-[550px] mx-7 md:mx-auto mt-[150px] px-8 sm:px-20 py-10 rounded-[40px] mb-20 bg-hero-image bg-black bg-opacity-60 bg-no-repeat bg-cover bg-center bg-blend-overlay">
				{/* *********************** REGISTER FORM *************************** */}
